...
import sk1 from '@/public/sk1.svg'
...
export function FeaturesSectionDemo() {
  const features = [
    ...
    },
    {
      ...
      description:
        "Designed to be used for medical industries allover the world, NoteMD using fast and scalable technology to boost productivity.",
        ...
        <div className="grid grid-cols-1 lg:grid-cols-6 mt-12 xl:border rounded-md dark:border-neutral-800">
          {features.map((feature) => (
            <FeatureCard key={feature.title} className={feature.className}>
              ...
              <div className=" h-[30vh] w-full">{feature.skeleton}</div>
            </FeatureCard>
          ))}
        </div>
      </div>
