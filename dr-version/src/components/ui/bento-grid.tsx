...
export const BentoGridItem = ({
  ...
  return (
    <div
      className={cn(
        "rounded-xl group hover:shadow-xl transition duration-200 shadow-input dark:shadow-none p-4 dark:bg-black dark:border-white/20 bg-white border border-transparent flex flex-col space-y-4",
        className
      )}
    >
      {header}
